...
QUESTIONS = [
    ...
    {
        "question": "太平洋側が夏に冷たい「やませ」の影響を受けやすいことを何といいますか。",
        "correct": "冷害",
        "wrong": ["干害", "風水害", "ひでりの害", "雹害", "霧害"],
        "explanations": {},
        "category": "気候とくらし",
    },
    {
        "question": "コシヒカリ（米）、ふじ（リンゴ）、ホルスタイン（乳牛）など、改良してブランド化したものを何といいますか。",
        "correct": "品種改良",
        "wrong": ["改良品種", "品種改造", "ブランド化", "魔改造", "食料改良"],
        "explanations": {},
        "category": "農業",
    },
    {
        "question": "冬でも暖かい土地で、ビニールハウスなどを生かして栽培する農業を何といいますか。",
        "correct": "促成栽培",
        "wrong": ["暖か栽培", "ビニールハウス栽培", "水耕栽培", "有機栽培"],
        "explanations": {},
        "category": "農業",
    },
    {
        "question": "遠くの海に出かけて、数十日～数か月かけて行う漁業を何といいますか。",
        "correct": "遠洋漁業",
        "wrong": ["沖合漁業", "沿岸漁業", "長期間漁業", "養殖漁業", "遠海漁業"],
        "explanations": {},
        "category": "水産業",
    },
    {
        "question": "養殖・栽培漁業が盛んな瀬戸内海では、プランクトンが多く集まって海が真っ赤に染まることがあり、それにより海水中の酸素が少なくなり生き物が死んでしまうことがあります。この海が真っ赤になる現象を何といいますか。",
        "correct": "赤潮",
        "wrong": ["黒潮", "青潮", "プランクトン増加現象", "赤海", "酸素減少"],
        "explanations": {},
        "category": "水産業",
    },
    {
        "question": "沿岸で日帰りで行う、赤潮の被害を受けやすい漁業を何といいますか。",
        "correct": "沿岸漁業",
        "wrong": ["遠洋漁業", "沖合漁業", "養殖漁業", "定置網漁業", "栽培漁業"],
        "explanations": {},
        "category": "水産業",
    },
    {
        "question": "卵を人工的にかえし、稚魚・稚貝になるまで育てた後に海に戻し、大きくなってからとる漁業を何といいますか。",
        "correct": "栽培漁業",
        "wrong": ["養殖漁業", "沖合漁業", "沿岸漁業", "遠洋漁業"],
        "explanations": {},
        "category": "水産業",
    },
    {
        "question": "いけすなどで魚・貝・海藻などを人工的に育てて、とる漁業を何といいますか。",
        "correct": "養殖漁業",
        "wrong": ["栽培漁業", "沖合漁業", "沿岸漁業", "育ててとる漁業", "遠洋漁業"],
        "explanations": {},
        "category": "水産業",
    },
    {
        "question": "1970年代から遠洋漁業が振るわなくなったのは、各国が200海里以内に○○を設けた影響などによります。○○とは何ですか。",
        "correct": "排他的経済水域",
        "wrong": ["領海", "排他的水域", "経済的排他水域", "領海排他水域"],
        "explanations": {},
        "category": "国土",
    },
]
